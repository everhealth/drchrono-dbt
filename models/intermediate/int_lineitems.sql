...
{% set days_limit = 90 if env_var('DBT_ENVIRONMENT') == 'test' else 365 %}
...
left join
    ...
    on bli.appointment_id = a.appointment_id and {{ days_ago("a.updated_at", days_limit) }}
